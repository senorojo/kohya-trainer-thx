...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.35,
        help="threshold of confidence to add a tag for general category",
    )
    parser.add_argument(
        "--character_threshold",
        type=float,
        default=0.35,
        help="threshold of confidence to add a tag for character category",
    )
    parser.add_argument(
        "--recursive",
        action="store_true",
